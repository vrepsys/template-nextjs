...
<img
  src={require("/img/demo-image-03.png").default}
  alt="Abstract art"
  style={{width: '400'}}
/>
...
<img
  src={require("/img/demo-image-01.png").default}
  alt="Abstract art"
  style={{width: '160'}}
/>
...
<figure style={{textAlign: 'center'}}>
  <img
    src={require("/img/demo-image-02.png").default}
    alt="Abstract art"
    style={{width: '160'}}
  />
</figure>
...
![Abstract art](/img/demo-image.svg)
...
Here's an example ![Abstract art](/img/demo-inline-image.svg) of an image embedded within a paragraph.
