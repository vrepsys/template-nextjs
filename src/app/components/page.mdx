...
<Callout type="success" title="Success">
  The success callout is a green callout designed to highlight positive outcomes
  or accomplishments. It draws attention to achievements and important
  confirmations, ensuring they are noticed.
</Callout>
...
````md showLineNumbers title="Markdown syntax"
...
<CodeBlock language="js" title="MDX syntax" showLineNumbers>
...
<Frame align="left" caption="Left aligned image">
   <Image width={160} src="/img/demo-image-01.png" alt="Abstract art"/>
</Frame>


<Frame  align="center" caption="Center aligned image">
   <Image width={160} src="/img/demo-image-02.png" alt="Abstract art"/>
</Frame>


<Frame align="right" caption="Right aligned image">
   <Image width={160} src="/img/demo-image-03.png" alt="Abstract art"/>
</Frame>
...
<CodeBlock title='Table using the gfm syntax'>
